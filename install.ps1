...
Copy-Item -Recurse -Force (Join-Path $Root "skills") $ProfileDir
Copy-Item -Recurse -Force (Join-Path $Root "commands") $ProfileDir
Copy-Item -Recurse -Force (Join-Path $Root "agents") $ProfileDir
