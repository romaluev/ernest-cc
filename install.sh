...
health_check() {
  ...
  require_file "ernest/health.py"
  require_file "ernest/selftest.py"
  require_file "ernest/telemetry.py"
  require_file "ernest/learn.py"
  require_file "ernest/improve.py"
...
ERNEST_SRC_DIR=$ROOT
ERNEST_UPDATE_CHANNEL=${ERNEST_UPDATE_CHANNEL:-main}
