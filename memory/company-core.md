...
- Enterprise product: Supercomputer — autonomous marketing agent stack
  ...
  Agent Toolkit, with policy guardrails and permissioning.

## Who we sell to (summary)

Primary B2B ICP: **AI studios, ad/creative agencies**, and brands that produce
high volumes of video. Also enterprises, Hollywood/AI studios, model and cloud
providers. Full grading rubric: `icp-b2b.md`.

Creators and prosumers are the self-serve base; B2B/enterprise is the growth and
revenue motion this assistant prioritizes.
...
- We are a fast-moving, well-funded category leader in AI video, not a tiny
  startup. Treat inbound accordingly — we qualify hard and do not chase everyone.
- Differentiator vs. generic text-to-video: workflow ("click-to-video"), camera
  control, aesthetic models, and an enterprise-grade, permission-first agent.
- Trust matters at enterprise: guardrails, permissioning, and auditability are
  part of the pitch.

## Operating defaults

- CRM: HubSpot (canonical for contacts, companies, deals, owners, stages).
- Email / calendar: Gmail or Microsoft 365, whichever is connected.
- Comms posture: draft-first; Alex approves every external send.
- Remote brain: VPS Ernest when configured; local fallback enabled.

## Dated facts (verify before quoting externally — update freely)

> Last updated: 2026-06-26. Some figures are company/press claims, not
